---
title: Roles page
description: In SQLite Cloud, a role is a set of permissions that allows a user to perform specific actions on a particular resource, such as a database or table.
---
