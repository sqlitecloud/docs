...
* [LIST ENV](https://docs.sqlitecloud.io/docs/list-env)
* [SET ENV](https://docs.sqlitecloud.io/docs/set-env) key VALUE value
* [GET ENV](https://docs.sqlitecloud.io/docs/get-env) key
* [REMOVE ENV](https://docs.sqlitecloud.io/docs/remove-env) key
