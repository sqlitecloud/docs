---
title: SQLite Cloud Command Line Interface
description: SQLite Cloud Command Line Interface.
---

**sqlitecloud-cli** is a terminal-based front-end to SQLite Cloud. It enables you to type in queries interactively, issue them to SQLite Cloud, and see the query results. Alternatively, input can be from a file or from command line arguments.
