---
title: LIST LOG
description: The LIST LOG command is used to retrieve the logs generated on server side. Logs can contains a huge number of entries, that's the reason why this command has so many filter options.
