...
description: The CREATE DATABASE command physically creates a new SQLite database using the name specified in the database_name parameter. If another database with the same name exists and the clausole IF NOT EXISTS is specified then OK is returned, otherwise the proper error is generated.
