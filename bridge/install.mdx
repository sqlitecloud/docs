---
title: Bridge LibreSSL Install
description: All the communications between the clients and the cluster are encrypted, and so you must link the LibreSSL (libtls) library with the SQLite Cloud Bridge.
---
