...
<div className="not-prose my-6 flex flex-wrap items-center gap-2">
  ...
  <a className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-3 py-1 text-sm font-medium text-slate-900 hover:border-slate-300" href="https://github.com/sqliteai/sqlite-vector" target="_blank" rel="noopener noreferrer">
