---
title: Build AI Search for Your Documentation
...
2. Execute a GET request with a URL-encoded query as the `query` parameter
   ...
   ```
   GET https://<your-project-id>.<your-hosted-zone>.gateway.sqlite.cloud/v2/functions/aisearch-docs?query=what%27s+Offsync%3F
   ```
...
function App() {
  return (
    <DocsChatbot
      searchUrl="https://<your-project-id>.<your-hosted-zone>.gateway.sqlite.cloud/v2/functions/aisearch-docs"
      apiKey="your-api-key"
      title="Help Center"
    />
  );
...
<html lang="en">
  ...
  <body>
    ...
    <docs-chatbot
      search-url="https://<your-project-id>.<your-hosted-zone>.gateway.sqlite.cloud/v2/functions/aisearch-docs"
