...
1. **Set up a SQLite Cloud account**
  - If you haven't already, <a href="https://dashboard.sqlitecloud.io/auth/sign-in" target="_blank">sign up for a SQLite Cloud account</a> and create a new database.
  - In this guide, we will use the sample datasets that come pre-loaded with SQLite Cloud.

2. **Create a Gin app**
  - You should have <a href="https://go.dev/doc/install" target="_blank">Go installed</a> locally.
