...
2. **Create a Laravel app**
  - If you haven't already done so, install PHP, Laravel, and Composer.
    - If you use macOS, you can install all 3 in 1 click by <a href="https://herd.laravel.com/docs/1/getting-started/installation#installation" target="_blank">downloading Laravel Herd</a>, a PHP dev environment.
...
If you're new to Laravel and want to learn more, we referenced the following Laravel Tutorial pages extensively when writing this Quickstart:
  - <a href="https://bootcamp.laravel.com/blade/installation" target="_blank">Installation</a>
  - <a href="https://bootcamp.laravel.com/blade/creating-chirps" target="_blank">Controllers, Routing, Blade</a>
