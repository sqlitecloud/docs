...
```bash
SQLITECLOUD_URL=sqlitecloud://myproject.myzone.sqlite.cloud:8860/chinook.sqlite?apikey=your-api-key
NEXT_PUBLIC_SQLITECLOUD_URL=sqlitecloud://myproject.myzone.sqlite.cloud:8860/chinook.sqlite?apikey=your-api-key
```
