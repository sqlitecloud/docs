...
2. **Create a Django app**
  - If you haven't already done so, <a href="https://docs.djangoproject.com/en/5.0/intro/install/" target="_blank">install Python and Django</a>.
...
If you're new to Django and want to learn more, we referenced the following Django Tutorial pages extensively when writing this Quickstart:
  - <a href="https://docs.djangoproject.com/en/5.0/intro/tutorial01" target="_blank">Part 1</a>
  - <a href="https://docs.djangoproject.com/en/5.0/intro/tutorial03" target="_blank">Part 3</a>
