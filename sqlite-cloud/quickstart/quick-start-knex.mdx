...
In this tutorial, we'll show you how to connect your TypeScript application to a SQLite Cloud database using the popular SQL builder, <a href="https://knexjs.org/" target="_blank">Knex.js</a>.
...
- A SQLite Cloud account (you can sign up for a free account <a href="https://dashboard.sqlitecloud.io/auth/sign-in" target="_blank">here</a>)
