---
title: "SQCloudRowsetInt32Value"
description: SQCloud Rowset C/C++ Interface SQCloudRowsetInt32Value
category: sdks
status: publish
---
...
### Description
If the result of the function [SQCloudResultType](/docs/sdks/c/sqcloudresulttype) is RESULT_ROWSET then use this function to retrieve the `int32_t` value of the item at row/col.
