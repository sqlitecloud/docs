...
An easy way to obtain a valid connection string is to click on the node address in the [Dashboard Nodes](/docs/architecture) section. A valid connection string will be copied in your clipboard.
</Callout>
...
int main (int argc, const char * argv[]) {
    const char *conninfo = "sqlitecloud://admin:admin@myproject.myzone.sqlite.cloud/invoice.sqlite";
