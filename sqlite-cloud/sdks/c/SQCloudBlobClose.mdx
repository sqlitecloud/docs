...
### Description
This function closes an open BLOB handle. The BLOB handle is closed unconditionally. Even if this routine returns an error code, the handle is still closed. This function resembles the <a href="https://www.sqlite.org/c3ref/blob_close.html" target="_blank">sqlite3_blob_close</a> SQLite API. 
