...
### Description
If the result of the function [SQCloudResultType](/docs/sdks/c/sqcloudresulttype) is RESULT_ARRAY then use this function to retrieve the number of items in the SQCloudResult array.
