...
We aim for full compatibility with the established <a href="https://docs.python.org/3/library/sqlite3.html" target="_blank">sqlite3 API</a>, with the primary distinction being that our driver connects to SQLite Cloud databases. This allows you to migrate your <a href="https://sqlite.ai" target="_blank">SQLite to the cloud</a> while continuing to use your existing codebase.

```python
import sqlitecloud

# Open the connection to SQLite Cloud
conn = sqlitecloud.connect("sqlitecloud://myproject.myzone.sqlite.cloud:8860?apikey=myapikey")

# You can autoselect the database during the connect call
# by adding the database name as path of the SQLite Cloud
# connection string, eg:
# conn = sqlitecloud.connect("sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase?apikey=myapikey")
...
conn = sqlitecloud.connect("sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase.sqlite?apikey=myapikey")
...
# Your SQLite Cloud connection string
connection_string = "sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase.sqlite?apikey=myapikey"
