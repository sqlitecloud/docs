...
let database = new Database('sqlitecloud://user:password@myproject.myzone.sqlite.cloud:8860/chinook.sqlite')
// or use sqlitecloud://myproject.myzone.sqlite.cloud:8860?apikey=xxxxxxx
