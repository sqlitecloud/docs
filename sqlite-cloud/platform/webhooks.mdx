...
For example, you can configure SQLite Cloud to notify a <a href="https://webhook.site" target="_blank">webhook.site</a> endpoint every time a write operation occurs on the `albums` table of the `chinook.sqlite` database.
