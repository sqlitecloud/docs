...
A <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">String</a> containing the IP address and port of the leader.
If the ID parameter is specified then the <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">Integer</a> nodeID of the leader node is returned.
