...
Several backup-related settings can be applied using the <a href="https://docs.sqlitecloud.io/docs/settings-commands#set-database-key" target="_blank">SET DATABASE KEY</a> command.
...
A <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">Rowset</a> with a single **name** column that returns all the databases with backup enabled.
