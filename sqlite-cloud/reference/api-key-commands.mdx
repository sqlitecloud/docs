...
It returns a <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">String</a> with the new APIKEY.
...
It returns a <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">Rowset</a> with the following columns:
* **username**: user name
* **key**: API KEY
* **name**: mnemonic name
...
It returns OK string or error value (see <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">SCSP</a> protocol).
