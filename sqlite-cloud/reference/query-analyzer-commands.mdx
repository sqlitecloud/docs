...
A <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">Rowset</a> with an analysis about the query id.
...
A <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">Rowset</a> with columns that depend on the command flags.
