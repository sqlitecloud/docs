...
A single value (usually a <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">String</a>) that depends on the input **keyname**.
...
A <a href="https://github.com/sqlitecloud/sdk/blob/master/PROTOCOL.md" target="_blank">String</a> with the requested value.
