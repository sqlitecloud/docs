...
export const WebliteSourceCode = `<script>
  async function searchData(event) {
    ...
    const response = await fetch(
      "https://abcdef123k.g4.gateway.sqlite.cloud/v2/functions/search-js?query=" + query
    )
...
export const SwiftSourceCode = `let configuration = SQLiteCloudConfig(connectionString: "sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase?apikey=myapikey")
...
export const PHPSourceCode = `$sqliteCloudConnectionString = 'sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase?apikey=myapikey';
...
let database = new Database('sqlitecloud://myproject.myzone.sqlite.cloud:8860/mydatabase?apikey=myapikey')
let name = 'Breaking The Rules'
